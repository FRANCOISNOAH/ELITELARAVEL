    ...
    $(function() {
        ...
        function completeTemplateInterfaceFeatures($questions) {
            ...
            add_option_buttons.each(function (index) {
               ...
               // Supprimer l'ancien gestionnaire d'événements avant d'en attacher un nouveau
                $('body').off('click', 'button.add-option').on('click', 'button.add-option', handleAddOptionClick);
        ...
        function finishUpFormFieldsExtras() {
            ...
            //Delete Form Field
            // Définir une fonction séparée pour le gestionnaire d'événement afin de pouvoir l'utiliser à plusieurs endroits
            ...
            // Supprimer l'ancien gestionnaire d'événements avant d'en attacher un nouveau
            $('body').off('click', 'button.question-delete').on('click', 'button.question-delete', handleQuestionDeleteClick);
        }
