...
@endphp
<p><center><h1>{{trans('try_user')}} {{trans($name)}} </h1></center></p>

@foreach ($fields as $field)
    @php
        $responses = $field->responses->where('user_id',$userid);
    ...
    <div class="col-md-12">
        ...
        @else
            @php $response_for_chart = $field->getResponseSummaryDataForChartUser2($userid); @endphp
