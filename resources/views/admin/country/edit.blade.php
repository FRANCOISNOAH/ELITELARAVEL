...
@section('ariane')
    ...
    <div aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><span class="bloo-color"><strong>Edittion d'un pays</strong></span></li>
        </ol>
    </div>
    <hr/>
@stop
            ...
            <div class="col-md-8 offset-2">
                <div class="mb-2">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" value="{{$country->name_fr}}" id="name_fr" name="name_fr">
                    </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" value="{{$country->name_en}}" id="name_en" name="name_en">
                    </div>
        ...
        $(document).ready(function () {
            ...
            $("#myForm").submit(function (event) {
                ...
                $.ajax({
                    ...
                    url: "{{route('countries.update',['country'=>$country->id])}}", // Remplacez par l'URL correcte
                    data: formData,
