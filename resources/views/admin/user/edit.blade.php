...
@section('ariane')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Editer un utilisateur</h1>
        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{route('user.index')}}"><h5>Tous les utilisateurs</h5></a></li>
            ...
            <div class="col-md-8 offset-2">
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" value="{{$user->email}}" readonly arial-label="Email"
                               aria-describedby="alt-addon" id="email" name="email"/>
                    </div>
                </div>


                @if($user->hasRole(['Client', 'Lecteur' , 'Operateur']))
                <div class="mb-2">
...
{{--                </div>--}}
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-block bg-bloo">Enregistrer</button>
                </div>
            </div>
        </div>
    </form>
        ...
        $(document).ready(function () {
            ...
            $("#myForm").submit(function (event) {
                ...
                if (!password || !confirmPassword) {
                    ...
                    formData = formData.replace(/&?password_confirmation=[^&]*/, '');
                }

                formData = formData.replace(/&?email=[^&]*/, '');
